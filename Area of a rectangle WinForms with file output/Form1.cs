...
namespace Area_of_a_rectangle_WinForms__2_
{
    public partial class Area_of_a_Rectangle_Calculator : Form
    {
        ...
        private void chkbox_write_to_file_CheckedChanged(object sender, EventArgs e)
        {
            txtbox_path.Enabled = true;
            txtbox_file_name.Enabled = true;
        }

        private void txtbox_width_TextChanged(object sender, EventArgs e)
        {
